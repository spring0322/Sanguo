...
namespace GameObjects
{
    ...
    public class Screen  // : DrawableGameComponent
    {
        ...
        */
        ...
        /// <summary>
        /// Get the visible world area based on the current transformation matrix
        /// </summary>
        /// <param name="transformMatrix">The transformation matrix (usually SpriteScale2 for main game)</param>
        /// <returns>Rectangle representing the visible world area with padding</returns>
