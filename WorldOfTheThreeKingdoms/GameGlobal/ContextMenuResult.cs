...
namespace WorldOfTheThreeKingdoms.GameGlobal
{
    public enum ContextMenuResult
    {
        ...
        Person_Appointment_AppointStrategist, //任命军师 (从建筑菜单)
        Monarch_AdvisorManagement_AppointStrategist, //君主菜单-任命军师
        Monarch_AdvisorManagement_RecallStrategist, //君主菜单-罢免军师
