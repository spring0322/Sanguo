            ...
            return new AIRoleConfig
            {
                ...
                AbilityProfiles = new AbilityProfilesConfig
                {
                    CombatMethods = new Dictionary<string, AbilityProfileEntry>
                    {
                        ...
                        ["10"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.EnemyTargetedOffense) },
                        ["11"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.EnemyTargetedOffense) },
                        ["12"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.EnemyTargetedOffense) },
                        ["13"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.EnemyTargetedOffense) },
                        ["20"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.SelfBuffOffense) },
                        ["21"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.SelfBuffOffense) },
                        ["22"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.SelfBuffOffense) },
                        ["27"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.EnemyTargetedOffense) },
                        ["28"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.EnemyTargetedOffense) },
                        ["29"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.EnemyTargetedOffense) },
                        ["30"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.EnemyTargetedOffense) },
                        ["31"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.SelfBuffOffense) },
                        ["32"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.SelfBuffOffense) },
                        ["33"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.SelfBuffOffense) },
                        ["34"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.EnemyTargetedOffense) },
                        ["35"] = new AbilityProfileEntry { Category = nameof(ActiveAbilityCategory.SelfBuffOffense) },
