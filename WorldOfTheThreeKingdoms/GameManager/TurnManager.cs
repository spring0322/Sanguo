...
namespace GameManager
{
    ...
    public class TurnManager
    {
        ...
        {
            // 🧊 Cold Path: 回合开始逻辑，可读性优先
            
            // 🔥 Anti-Band-Aid: 只在入口检查必要的前置条件
        ...
        private void ProcessResourceGrowth(Faction faction)
        {
            ...
            // 🔥 Anti-Band-Aid: 不做 try-catch，让数据错误暴露
            // 示例：简单的资源增长
        ...
        private Person GetStrategist(Faction faction)
        {
            ...
            {
                // 🔥 Anti-Band-Aid: 假设 GetList() 不返回 null 元素
                // 如果返回了 null，应该让它崩溃暴露问题
            ...
            // 只有智力超过80的才能当军师
            if (strategist != null && strategist.Intelligence >= 80)
            {
                return strategist;
            }
