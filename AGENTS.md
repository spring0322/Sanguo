...
# Extra Project Rules (项目额外规则)
本仓库的补充规范文件在 `D:\sanguo260323\.codex\` 下（例如：ID 判断/序列化/空引用调试/数据验证等）。
当任务涉及对应主题时，必须同时遵循这些规范；如需引用细则，请优先读取相关文件：
- `D:\sanguo260323\.codex\ID判断规范.md`
- `D:\sanguo260323\.codex\MonoGame-SpriteBatch规范.md`
- `D:\sanguo260323\.codex\NullReferenceException调试规范.md`
- `D:\sanguo260323\.codex\System.Text.Json序列化规范.md`
- `D:\sanguo260323\.codex\复用现有功能规范.md`
- `D:\sanguo260323\.codex\数据加载问题诊断规范.md`
- `D:\sanguo260323\.codex\枚举和数据验证规则.md`
- `D:\sanguo260323\.codex\游戏核心机制.md`
